...
$sql = $dbh->prepare("select * from (SELECT *FROM pdfformupload ORDER BY id desc) T where probcomesunder='Basic of Sciences and Humanity'");
$sql->execute();
...
<body>
	<div class="jumbotron">
	<center>	<h1><i class="fa fa-newspaper-o" aria-hidden="true"></i> <b>View Basic of Sciences and Humanity Projects</b> <i class="fa fa-newspaper-o" aria-hidden="true"></i></h1>
