...
$sql = $dbh->prepare("select * from (SELECT *FROM pdfformupload ORDER BY id desc) T where probcomesunder='Information Technology'");
$sql->execute();
...
<body>
	<div class="jumbotron">
	<center>	<h1><i class="fa fa-newspaper-o" aria-hidden="true"></i> <b>VIEW I.T. Projects</b> <i class="fa fa-newspaper-o" aria-hidden="true"></i></h1>
